...
class CVUSA(torch.utils.data.Dataset):
    def __init__(self, train_file=None, mode = '', root = '/home/parthpk/CVUSA/', same_area=True, print_bool=False, polar = '',args=None): #CV-dataset
        ...
        self.train_list = splits_path + 'splits/' + self.train_file
